...
const HomeSection1 = () => {
  return (
    <div className='bg-cover bg-center h-[28rem] flex flex-col items-start justify-center w-full text-white px-6 pt-28 
    md:px-14 lg:h-[35.5rem] lg:px-16 xl:h-[50rem] xl:px-24 xl:mb-10'
    style={{backgroundImage: `url(${bgImg})`}}
    >
      <div>
        <h1 className='text-[27px] font-light leading-9 md:text-[35px] md:font-normal md:leading-[2.7rem] lg:text-[48px] lg:leading-[3.5rem]
        xl:text-[68px] xl:leading-[4.7rem]'>
          We deliver DevOps <br />
          solutions exactly <br /> 
          as you need it
        </h1>
      </div>
